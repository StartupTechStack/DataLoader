...
[assembly: WebActivator.PreApplicationStartMethod(typeof(StartupTechStackWebApp.App_Start.AppHost), "Start")]
...
namespace StartupTechStackWebApp.App_Start
{
	...
	{		
		public AppHost() //Tell ServiceStack the name and where to find your web services
			: base("Startup Tech Stack", typeof(CrunchbaseGateway).Assembly) { }
